...
Opening a pull request will trigger a[workflow](../.github/workflows/run-tests-fs.yml) 
...
* [Staging workspace registered model](https://e2-demo-field-eng.cloud.databricks.com#mlflow/models/staging-mlops-model)
* [Prod workspace registered model](https://e2-demo-field-eng.cloud.databricks.com#mlflow/models/prod-mlops-model)
